...
public class MainController {
    ...
    public String registerUser(@ModelAttribute("userName") String userName,
        ...
        model.addAttribute("message", userService.checkRegister(userName, password1, password2, foxName));
    ...
    public String loginPost(@ModelAttribute("userName") String userName,
        ...
        if (userService.checkLogin(userName, password) == "Successful login, check your fox!") {
            returnMessage = "redirect:/pfc/information?userName=" + userName;
        } else {
            returnMessage = "afterlogin";
        }
